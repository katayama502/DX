...
export default function Menu() {
  const { session, backend, access } = useApp()
    ...
    <>
      ...
      <Page>
        ...
        <section className="card">
          ...
          {access === 'ok' ? <Link to="/account" className="btn-ghost btn-sm mt-2">氏名・パスワードの変更</Link> : <p className="text-[13px] text-lv-yellow mt-2">閲覧期間中はアカウント情報を変更できません。</p>}
        </section>
